...
export const ConnectionStatus: React.FC = () => {
  ...
  const loadSettings = () => {
    ...
    setSavedGemini(!!localStorage.getItem('gemini_custom_api_key'));
    if (gKey) setGeminiKey(localStorage.getItem('gemini_custom_api_key') || '');

    const oKey = getApiKey('openai');
    setSavedOpenai(!!localStorage.getItem('openai_custom_api_key'));
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="grid grid-cols-2 gap-4">
            <button
                ...
                className={`p-6 rounded-xl border-2 transition-all flex flex-col items-center gap-3 relative overflow-hidden ${
