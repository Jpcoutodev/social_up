...
const Scene = ({ scene, gradient }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, durationInFrames, width } = (0,esm.useVideoConfig)();
  ...
  const slideY = (0,esm.interpolate)(slideProgress, [0, 1], [height / 2, 0]);
  const opacity = (0,esm.interpolate)(frame, [0, 10], [0, 1], { extrapolateRight: "clamp" });
  const scaleImage = (0,esm.interpolate)(frame, [0, durationInFrames], [1, 1.15], {
    extrapolateRight: "clamp"
  });
  const words = (0,react.useMemo)(() => scene.text.split(" "), [scene.text]);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#000", overflow: "hidden" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { opacity, transform: `translateY(${slideY}px)` }, children: [
      scene.imageUrl ? /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { transform: `scale(${scaleImage})` }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        esm.Img,
        {
          src: scene.imageUrl,
          style: {
      ...
      ) }) : /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: gradient } }),
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: words.map((word, i) => {
              ...
              const wordOpacity = (0,esm.interpolate)(frame, [wordStartFrame, wordStartFrame + 5], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp"
              });
              const wordScale = (0,esm.interpolate)(wordSpring, [0, 1], [0.5, 1]);
              const wordTranslateY = (0,esm.interpolate)(wordSpring, [0, 1], [20, 0]);
...
const GRADIENTS = [
  ...
  "linear-gradient(to bottom right, #ee9ca7, #ffdde1)",
  ...
  "linear-gradient(to bottom right, #06beb6, #48b1bf)"
];
const MUSIC_TRACKS = {
  "Happy": "https://cdn.pixabay.com/audio/2022/05/27/audio_1808fbf07a.mp3",
  // Upbeat
  "Inspirational": "https://cdn.pixabay.com/audio/2022/10/25/audio_544e3328ce.mp3",
  // Corporate/Inspiring
  "Sad": "https://cdn.pixabay.com/audio/2021/11/24/audio_c3e1e69507.mp3",
  // Piano melancholy
  "Epic": "https://cdn.pixabay.com/audio/2022/03/09/audio_c8c8a73467.mp3",
  // Cinematic
  "Chill": "https://cdn.pixabay.com/audio/2022/01/18/audio_d0a13f69d2.mp3",
  // Lofi
  "Dark": "https://cdn.pixabay.com/audio/2022/04/27/audio_67bcf729cf.mp3",
  // Suspense
...
const VideoComposition = ({ script }) => {
  const musicUrl = (0,react.useMemo)(() => {
    const mood = script.backgroundMusicMood;
    const availableMoods = Object.keys(MUSIC_TRACKS);
    const matchedKey = availableMoods.find(
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#000" }, children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Series, { children: script.scenes.map((scene, index) => {
      const durationInFrames = Math.ceil(scene.durationInSeconds * VIDEO_FPS);
      const gradient = GRADIENTS[index % GRADIENTS.length];
      return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Series.Sequence, { durationInFrames, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene, { scene, gradient }),
        scene.audioUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.Audio,
          {
            src: scene.audioUrl,
            volume: 1
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "shorts-factory-ai:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkshorts_factory_ai"] = self["webpackChunkshorts_factory_ai"] || [];
